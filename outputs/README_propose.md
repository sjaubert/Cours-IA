...
### Formation modules HTML, version 1 (8 modules) [à réviser]

Séquence complète de sensibilisation, du contexte à la feuille de route.

Note : ces huit modules datent de novembre 2025 et recoupent le prompt engineering de la section 2. À conserver ou à archiver selon ce qui y reste unique.
...
- [Plan Formation IA : AFPI](00-Formation/Plan_Formation_IA_AFPI.md) | MD | Dispositif de formation IA adapté au contexte AFPI. [Version Word](00-Formation/Plan_Formation_IA_AFPI.docx) <sub>*(avr. 2026)*</sub>
...
*Dernière mise à jour : 28 juillet 2026. Structure et liens revus. Voir Audit_et_Reorganisation_Cours-IA.md.*
