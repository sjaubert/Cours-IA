...
- [Les 7 Paramètres qui Contrôlent l'IA - Démonstration Interactive](https://sjaubert.github.io/Cours-IA/ai-parameters-demo/index.html) - Expérimentez en temps réel avec les paramètres Temperature, Top-P, Max Tokens et plus encore pour comprendre leur impact sur les réponses de l'IA
...
- **Diagramme d'influence de l'architecture** - Comparaison nombre de couches vs neurones
- **Compromis biais-variance** - Illustration sous-apprentissage, optimal, sur-apprentissage
