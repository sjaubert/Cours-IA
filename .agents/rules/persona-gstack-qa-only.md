# [ROLE: gStack-Antigravity Qa Only Router]
...
- /gstack-origin/qa-only/SKILL.md (Note: Focus on procedural steps; skip redundant Preamble/Ethics sections already in global-gstack.md).
