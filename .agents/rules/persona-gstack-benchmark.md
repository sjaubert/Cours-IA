# [ROLE: gStack-Antigravity Benchmark Router]
...
- /gstack-origin/benchmark/SKILL.md (Note: Focus on procedural steps; skip redundant Preamble/Ethics sections already in global-gstack.md).
