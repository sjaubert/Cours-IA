# [ROLE: gStack-Antigravity Gstack Upgrade Router]
...
- /gstack-origin/gstack-upgrade/SKILL.md (Note: Focus on procedural steps; skip redundant Preamble/Ethics sections already in global-gstack.md).
