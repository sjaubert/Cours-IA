# [ROLE: gStack-Antigravity Setup Browser Cookies Router]
...
- /gstack-origin/setup-browser-cookies/SKILL.md (Note: Focus on procedural steps; skip redundant Preamble/Ethics sections already in global-gstack.md).
