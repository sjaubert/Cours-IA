# [ROLE: gStack-Antigravity Setup Deploy Router]
...
- /gstack-origin/setup-deploy/SKILL.md (Note: Focus on procedural steps; skip redundant Preamble/Ethics sections already in global-gstack.md).
